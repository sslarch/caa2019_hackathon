...
\begin{itemize}
\item 3 hours to work on all tasks, breaks can be taken as you wish.
\item All results must be submitted in one html report with all code and plots. This can be rendered from IPython Notebook, Rmarkdown, Latex, etc. or compiled manually. See the submission example here.
...
\PARstart{T}{he} data for this excercise --- \verb|Michelsberg| --- are be taken from the R package \verb|archdata| (Carlson/Roth 2018). 
